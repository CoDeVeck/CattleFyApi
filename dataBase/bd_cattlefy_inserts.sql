...
('Jorge', 'Ramirez', 'Silva', '45678903', 'jorge.ramirez@email.com', '$2a$10$hashed_password_3', '987654323', 'firebase_uid_003', NULL, 3, TRUE),
('Ana', 'Lopez', 'Perez', '45678904', 'ana.lopez@email.com', '$2a$10$hashed_password_4', '987654324', 'firebase_uid_004', 'https://example.com/img/ana.jpg', 2, TRUE),
('Pedro', 'Vargas', 'Castro', '45678905', 'pedro.vargas@email.com', '$2a$10$hashed_password_5', '987654325', 'firebase_uid_005', NULL, 3, TRUE),
('Lucia', 'Flores', 'Quispe', '45678906', 'lucia.flores@email.com', '$2a$10$hashed_password_6', '987654326', 'firebase_uid_006', NULL, 3, TRUE),
('Roberto', 'Sanchez', 'Diaz', '45678907', 'roberto.sanchez@email.com', '$2a$10$hashed_password_7', '987654327', 'firebase_uid_007', NULL, 2, TRUE),
('Carmen', 'Rojas', 'Mejia', '45678908', 'carmen.rojas@email.com', '$2a$10$hashed_password_8', '987654328', 'firebase_uid_008', NULL, 3, TRUE);
...
(1, 'Granja El Paraiso', 'Av. Los Pinos 456, Canete', -12.1234567, -76.5432109, 'https://example.com/granja2.jpg'),
...
(1, 'Novillos Engorde', 'Engorde', 'Forraje + concentrado 18% proteina'),
...
(2, 'Reproductores Porcinos', 'Reproduccion', 'Alimento gestacion/lactancia'),
...
(3, 'Ovinos Descarte', 'Descarte', 'Pastura basica'),
...
-- Aves
(5, 'Pollos Bebe', 'Enfermeria', 'Alimento iniciador 21% proteina'),
(5, 'Pollos Engorde', 'Engorde', 'Alimento crecimiento 19% proteina'),
...
(2, 'Establo Los Alamos', '2024-02-01', 4, 13700.00, 'Vacas lecheras Holstein'),
...
(14, 'Ganaderia Andina', '2024-03-01', 5, 8250.00, 'Novillos jovenes'),
(9, 'Avicola Santa Clara', '2024-03-15', 30, 450.00, 'Gallinas ponedoras'),
(15, 'Cuyes Peru', '2024-04-10', 25, 200.00, 'Cuyes de 2 meses');
...
(2, NULL, 'Masivo', 'Tratamiento', 'Desparasitante Ovino', 4.00, 1, 7, '2024-01-10'),
(2, NULL, 'Masivo', 'Vacuna', 'Triple Bovina', 8.50, 1, 5, '2024-03-10'),
(2, NULL, 'Masivo', 'Tratamiento', 'Vitaminas ADE', 6.00, 1, 5, '2024-04-20'),
(2, NULL, 'Masivo', 'Vacuna', 'Newcastle', 0.15, 1, 30, '2024-03-25'),
(15, NULL, 'Masivo', 'Tratamiento', 'Desparasitante', 0.50, 1, 25, '2024-04-20'),

-- Individuales
(NULL, 10, 'Individual', 'Tratamiento', 'Antibiotico Mastitis', 15.00, 3, NULL, '2024-04-15'),
(NULL, 11, 'Individual', 'Tratamiento', 'Complejo Vitaminico', 8.00, 1, NULL, '2024-05-20'),
(NULL, 30, 'Individual', 'Tratamiento', 'Antibiotico Respiratorio', 10.00, 2, NULL, '2024-05-10'),
-- Vacunas masivas
(3, NULL, 'Masivo', 'Vacuna', 'Brucelosis', 12.00, 1, 5, '2024-02-10'),
(3, NULL, 'Masivo', 'Vacuna', 'Carbunco Sintomatico', 10.00, 1, 5, '2024-03-15'),
(4, NULL, 'Masivo', 'Vacuna', 'Fiebre Aftosa', 15.00, 1, 5, '2024-04-20'),
(2, NULL, 'Masivo', 'Vacuna', 'IBR-DVB (Respiratoria)', 18.00, 1, 5, '2024-05-10'),
(3, NULL, 'Masivo', 'Vacuna', 'Leptospirosis', 14.00, 1, 5, '2024-06-05'),
...
-- Tratamientos individuales - Mastitis
(NULL, 10, 'Individual', 'Tratamiento', 'Antibiotico Mastitis (Cefalexina)', 15.00, 3, NULL, '2024-04-15'),
(NULL, 11, 'Individual', 'Tratamiento', 'Antibiotico Mastitis (Gentamicina)', 18.00, 2, NULL, '2024-05-20'),
(NULL, 12, 'Individual', 'Tratamiento', 'Antibiotico Mastitis (Oxitetraciclina)', 16.00, 3, NULL, '2024-06-10'),

-- Tratamientos individuales - Vitaminas y suplementos
(NULL, 13, 'Individual', 'Tratamiento', 'Complejo Vitamínico B12', 8.00, 1, NULL, '2024-03-25'),
(NULL, 14, 'Individual', 'Tratamiento', 'Calcio + Fosforo (Ternera)', 12.00, 2, NULL, '2024-05-15'),
(NULL, 10, 'Individual', 'Tratamiento', 'Suero Energizante', 10.00, 1, NULL, '2024-07-05'),

-- Tratamientos individuales - Problemas digestivos
(NULL, 11, 'Individual', 'Tratamiento', 'Antibiotico Digestivo', 14.00, 2, NULL, '2024-04-30'),
(NULL, 12, 'Individual', 'Tratamiento', 'Probioticos Ruminales', 9.00, 3, NULL, '2024-06-20'),

-- Tratamientos individuales - Otros
(NULL, 13, 'Individual', 'Tratamiento', 'Antiinflamatorio (Flunixin)', 11.00, 2, NULL, '2024-05-05'),
(NULL, 10, 'Individual', 'Tratamiento', 'Antibiotico Respiratorio', 13.00, 3, NULL, '2024-08-15'),
 
-- Tratamientos individuales - Otros
(2, 13, 'Individual', 'Tratamiento', 'Antiinflamatorio (Flunixin)', 11.00, 2, NULL, '2024-11-05'),
(2, 10, 'Individual', 'Tratamiento', 'Antibiotico Respiratorio', 13.00, 3, NULL, '2024-10-15');
...
(28, 5, 6, '2024-05-20', 'Oveja prenada a lote de corderos'),
(14, 2, 4, '2024-06-10', 'Ternera destetada a enfermeria'),
...
(1, 'Parcial', 'Engorde', 392.00, 18.50, 7252.00, 28.50, 25.00, 'Frigorifico del Centro SAC', '2024-05-20', ARRAY[4]),
(3, 'Parcial', 'Engorde', 110.00, 12.00, 1320.00, 22.00, 20.00, 'Mercado de Carnes', '2024-06-18', ARRAY[19]),
(8, 'Total', 'Engorde', 1200.00, 8.50, 10200.00, 35.00, 30.00, 'Distribuidora Avicola', '2024-06-25', NULL),
(13, 'Total', 'Descarte', 420.00, 12.00, 5040.00, 15.50, 15.00, 'Procesadora del Sur', '2024-06-01', NULL);

-- ============================================
-- 16. TIPOS DE NOTIFICACION
-- ============================================
INSERT INTO tb_tipos_notificacion (codigo, descripcion) VALUES
('VACUNA_PROXIMA', 'Vacunacion proxima a vencer'),
('PESO_META', 'Animal alcanzo peso meta'),
('PRODUCCION_BAJA', 'Produccion por debajo del promedio'),
...
('CAPACIDAD_LOTE', 'Lote cerca de capacidad maxima'),
('ALIMENTACION_PENDIENTE', 'Registro de alimentacion pendiente');
...
(1, 1, 1, 'Vacunacion Pendiente', 'El lote Bovino A1 requiere refuerzo de vacuna', 1, NULL, NULL, '2024-06-10', FALSE, FALSE),
(1, 1, 2, 'Peso Objetivo', 'El animal QR_BOV_001 alcanzo 455 kg', 1, 1, NULL, '2024-06-15', TRUE, FALSE),
(1, 1, 5, 'Venta Registrada', 'Venta completada por S/ 7,252.00', 1, NULL, 1, '2024-05-20', TRUE, FALSE),
(2, 2, 3, 'Produccion Baja', 'Produccion de lote O1 bajo promedio', 5, NULL, NULL, '2024-06-01', FALSE, FALSE),
...
(5, 7, 7, 'Capacidad Maxima', 'Lote CU1 al 95% de capacidad', 15, NULL, NULL, '2024-06-15', FALSE, FALSE),
(1, 1, 8, 'Alimentacion', 'Registrar alimentacion del lote B1', 2, NULL, NULL, '2024-06-20', FALSE, FALSE);
