...
public class LoteDisponibleVentaResponse {
    ...
    private BigDecimal costoTotalAcumulado; // alimentación + sanidad + compras (CVT)
    
    private BigDecimal precioSugeridoPorKgBase; // precio x kg
    private BigDecimal roiEstimadoPorcentaje; // ROI x defecto: 30% por defecto
